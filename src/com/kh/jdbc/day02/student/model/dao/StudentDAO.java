...
public class StudentDAO {
	...
	public List<Student> selectAll() {
		...
		try {
			...
			// 4. 쿼리문 실행 및 5. 결과 받기
			ResultSet rset = stmt.executeQuery(query); // SELECT가 아니면 ResultSet 안씀
...
//			while(rset.next()) {}
	...
	//		INSERT INTO STUDENT_TBL VALUES('admin', 'admin', '관리자', 'M', 30, 'admin@iei.or.kr', '01012345678', '서울시 강남구 역삼동 테헤란로 7', '기타,독서,운동', SYSDATE);
			...
			try {
				...
				Statement stmt = conn.createStatement();
				// 4. 실행하고 결과받기
	//			stmt.executeQuery(query);	// SELECT 용
	...
	//		UPDATE STUDENT_TBL 
	//		SET STUDENT_PWD = 'pass11', EMAIL = 'khuser02@iei.or.kr', PHONE = '01024214521'
