...
//			ResultSet rset = stmt.executeQuery(query);
	...
	public Student selectLoginIfo(Student student) {
...
//			pstmt.setString(4, String.valueOf(student.getGender())); char 를 String으로 바꿔주는 두가지 방법
...
//			result = stmt.executeUpdate(query);	
	...
	private Student rsetToStudent(ResultSet rset) throws SQLException {
		...
		student.setStudentId(rset.getString(1));	// 컬럼의 순번으로도 갖고올수있음
